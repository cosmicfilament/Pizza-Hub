...
/**
    * @file server file. starts the http and https server and listens for requests and sends responses
    * @module server.js
* @description http/https server and request handler
  */
...
server.init = () => {
  ...
  server.httpServer.listen(config.httpPort, () => {
    ...
    logs.log(`The http server is listening on port ${config.httpPort}.`);
  });
  ...
  server.httpsServer.listen(config.httpsPort, () => {
    ...
    helpers.log('white', '<--------------------------------------------------------->');
    logs.log(`The https server is listening on port ${config.httpsPort}.`);
    logs.log('<--------------------------------------------------------->');
  });
