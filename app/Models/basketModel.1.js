 ...
 */
class Basket {
    constructor(id = '', phone = '', basket = []) {
        this.init(id, phone, basket);
    }
    /**
     * @summary init
     * @description Basket init method
     */
    init(id, phone, basket, basketTotal) {
        this.id = id;
        this.phone = phone;
        this.basket = basket;
    ...
    */
    validatebasket() {
        ...
        if (!helpers.validateArray(this.basket)) {
            return 'basket';
        }
        return true;
    }
    ...
    * @throws nothing
    */
    validateBasketObj(skipId = false) {
